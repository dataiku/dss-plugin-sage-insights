...
class MyRunnable(Runnable):
    def __init__(self, project_key, config, plugin_config):
        ...
        self.repo = plugin_config.get("sage_repo_url", "https://github.com/dataiku/dss-plugin-sage-insights")
        self.branch = plugin_config.get("sage_repo_branch", "dev-mazzei-v1.3")
