...
def main(filters = {}):
    ...
    query["select"] = ["base.timestamp", "base.author", "base.instance_name", "base.project_key"]
    ...
    filtered_df = filtered_df.groupby(["instance_name", "project_key"]).size().reset_index(name="count")
